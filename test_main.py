...
class TestMain(unittest.TestCase):
    ...
    def test_crud_operations(self, mock_create_connection):
        ...
        updated_items = get_all_items()  # Assuming you want to mock the same method here
        self.assertEqual(updated_items[0][3], 2.0)

        # Remove TestItem (Delete)
        mock_cursor.fetchall.return_value = []
        self.assertFalse(get_all_items())  # Assuming you want to mock the same method here
